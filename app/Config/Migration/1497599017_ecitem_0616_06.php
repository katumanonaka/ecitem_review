<?php
class Ecitem061606 extends CakeMigration {
 ...
 * @var string
 */
	public $description = 'ecitem_0616_06';
 ...
 */
	public $migration = array(
		'up' => array(
			...
			'drop_field' => array(
				'test' => array('indexes' => array('t')),
			),
			'drop_table' => array(
				'articles', 'categories', 'comments', 'companies', 'jobs', 'products', 'test1', 'test2', 'test3', 'users'
			),
		),
		'down' => array(
			'alter_field' => array(
